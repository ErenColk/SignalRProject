...
namespace SignalRWebUI.Controllers
{
    public class SocialMediaController : Controller
    {
        ...
        public async Task<IActionResult> CreateSocialMedia(CreateSocialMediaDto createSocialMediaDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7194/api/SocialMedia", stringContent); // API'ye git ve giderken olusturdugumuz kaynağı götür.
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7194/api/SocialMedia/{id}");
        ...
        public async Task<IActionResult> UpdateSocialMedia(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7194/api/SocialMedia/{id}");
        ...
        public async Task<IActionResult> UpdateSocialMedia(UpdateSocialMediaDto updateSocialMediaDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7194/api/SocialMedia", stringContent);
