...
namespace SignalRWebUI.Controllers
{
    public class AboutController : Controller
    {
        ...
        public async Task<IActionResult> CreateAbout(CreateAboutDto createAboutDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7194/api/About", stringContent); // API'ye git ve giderken olusturdugumuz kaynağı götür.
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7194/api/About/{id}");
        ...
        public async Task<IActionResult> UpdateAbout(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7194/api/About/{id}");
        ...
        public async Task<IActionResult> UpdateAbout(UpdateAboutDto updateAboutDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7194/api/About", stringContent);
