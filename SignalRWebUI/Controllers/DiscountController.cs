...
namespace SignalRWebUI.Controllers
{
    public class DiscountController : Controller
    {
        ...
        public async Task<IActionResult> CreateDiscount(CreateDiscountDto createDiscountDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7194/api/Discount", stringContent); // API'ye git ve giderken olusturdugumuz kaynağı götür.
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7194/api/Discount/{id}");
        ...
        public async Task<IActionResult> UpdateDiscount(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7194/api/Discount/{id}");
        ...
        public async Task<IActionResult> UpdateDiscount(UpdateDiscountDto updateDiscountDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7194/api/Discount", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient(); // Bir istemci yarat 
            await client.GetAsync($"https://localhost:7194/api/Discount/ChangeStatusToTrue/{id}"); //Tetiklenecek yer 
        ...
        {
            var client = _httpClientFactory.CreateClient(); // Bir istemci yarat 
            await client.GetAsync($"https://localhost:7194/api/Discount/ChangeStatusToFalse/{id}"); //Tetiklenecek yer 
